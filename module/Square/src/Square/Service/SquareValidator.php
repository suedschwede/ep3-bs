...

{
    ...
    {
        // Heinz nur 1 Buchung pro Tag erlaubt
        ...
        if ($user) {
            ...
            if ($maxActiveBookings != 0) {
                ...
                foreach ($activeBookings as $activeBooking) {
                    ...
                    foreach ($activeBooking->getExtra('reservations') as $activeReservation) {
                        ...
                        if ($activeReservationDate > new DateTime()) {
                         ...
                         // Heinz nur 1 Buchung pro Tag erlaubt
                         if ($bookingdate==$activeReservation->get('date')) {
                          $activeDailyBookingsCount++;
                        }
                ...
                // Heinz nur 1 Buchung pro Tag erlaubt
                if ($activeDailyBookingsCount > 0) {

                    $bookable = false;

                    $notBookableReason = 'Sie können derzeit nur <b> 1 aktive Buchung/en</b> pro Tag offen haben.';
